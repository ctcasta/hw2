...
source('submission_1/data_code/HCRIS_v1996.R')
source('submission_1/data_code/HCRIS_v2010.R')
...
## combine v1996 and v2010 hcris forms, and sort by number and year
...
## calculate elapsed time between fiscal year start and end for hospitals with multiple reports
duplicate.hcris = 
  duplicate.hcris %>% 
  group_by(provider_number, fyear) %>%
